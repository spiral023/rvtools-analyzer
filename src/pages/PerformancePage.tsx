...
import { useActiveSnapshotIds, useVms, useRawSheet } from "@/hooks/useActiveSnapshots";
...
function PerformancePage({ vmDetailsOnly = false }: { vmDetailsOnly?: boolean }) {
  ...
  const dataLoading = snapshotsLoading || vmsLoading || rawVMemoryLoading || rawVCPULoading
    || rawMultiPathLoading || rawVNetworkLoading || rawVInfoLoading;
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <GlobalFilterScopeHint text="Multipath bleibt unverändert; VM-bezogene Performance-Sichten folgen dem globalen Filter." />
      <KpiGrid>
...
export function VmPerformanceDetails() {
  return <PerformancePage vmDetailsOnly />;
}
