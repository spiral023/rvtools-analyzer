...
/**
 * Eigenständige Diagnoseseite. Aktuell nicht verlinkt — die Diagnose lebt im
 * Tab unter `/upload?tab=diagnostics` (`DiagnosticsPanel`). Der Analyse-Export
 * kommt hier aus derselben Komponente, damit beide Einstiege nicht auseinanderlaufen.
 */
