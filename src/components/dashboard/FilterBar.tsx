  ...
  return (
    <div className="flex min-w-0 flex-wrap items-center gap-2 animate-fade-in">
      ...
      <div className="relative">
        ...
        <Input
          placeholder="VM, Host, OS, SysV, Abteilung …"
          title="Durchsucht VM-Name, Cluster, Host, Betriebssystem, Systemverantwortliche:r und deren Abteilung (Pfad „Organisation/Bereich-Abteilung“). Alle Auswertungen der Seite folgen dem Ergebnis."
          value={searchLocal}
