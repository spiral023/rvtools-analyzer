...
const diagnostics: DiagnosticsResult = {
  ...
  stores: [
    { storeName: "entities_vm", count: 12, estimatedSizeBytes: 2048 },
    { storeName: "entities_host", count: 3, estimatedSizeBytes: 1024 },
  ],
  storage: { supported: true, usageBytes: 4096, quotaBytes: 8192 },
  sampleQuery: { store: "entities_vm", snapshotCount: 1, rowCount: 12, durationMs: 4 },
