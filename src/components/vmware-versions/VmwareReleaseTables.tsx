...
export function VCenterVersionsTable() {
  ...
  return <div><InfoTooltip entry={COMPLIANCE_SECTIONS.vcenterVersionsTable} side="bottom"><h3 className="mb-3 w-fit cursor-help text-sm font-semibold text-muted-foreground">Neueste vCenter Versionen</h3></InfoTooltip><VirtualTable tableId="compliance/vcenter-versions" columnPicker data={rows} columns={columns} height={260} /><ReleaseUsageDialog release={selectedRelease} entityLabel="vCenter" entries={entries} open={selectedRelease !== null} onClose={() => setSelectedRelease(null)} /></div>;
}
...
export function EsxiVersionsTable() {
  ...
  return <div><InfoTooltip entry={COMPLIANCE_SECTIONS.esxiVersionsTable} side="bottom"><h3 className="mb-3 w-fit cursor-help text-sm font-semibold text-muted-foreground">Neueste ESXi Versionen</h3></InfoTooltip><VirtualTable tableId="compliance/esxi-versions" columnPicker data={rows} columns={columns} height={260} /><ReleaseUsageDialog release={selectedRelease} entityLabel="ESXi Host" entries={entries} open={selectedRelease !== null} onClose={() => setSelectedRelease(null)} /></div>;
}
