...
import { metricStatsFixture, rightsizingCandidateFixture } from "@/test/fixtures/vmWorkload";
...
function metricStats(overrides: Partial<VmWorkloadProfileMetricStats> = {}): VmWorkloadProfileMetricStats {
  return metricStatsFixture({ average: 300, p50: 350, p95: 500, p99: 650, maximum: 700, ...overrides });
}

function candidate(overrides: Partial<VmRightsizingCandidate> = {}): VmRightsizingCandidate {
  const base = rightsizingCandidateFixture({ objectKey: "vm:vm-01" });
  return {
    ...base,
    vmName: "vm-01",
    hostName: "esx-01",
    vcpu: 8,
    demand: metricStats(),
    ready: metricStats({ average: 0.5, p50: 0.5, p95: 1.2, p99: 1.8, maximum: 2 }),
    mhzPerCore: 250,
    mhzPerVcpu: 250,
    ...
    recommendedVcpu: 6,
    reclaimableVcpu: 2,
    flags: { ...base.flags, manyVcpuLowDemand: true },
    ...overrides,
  };
}
