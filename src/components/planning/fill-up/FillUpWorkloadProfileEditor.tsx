  ...
  return (
    <section className="space-y-3">
      ...
      <div className="space-y-2">
        {profiles.map((profile) => <div key={profile.id} className="configuration-list-entry grid gap-2 rounded-md border bg-background/50 p-2.5 sm:grid-cols-[minmax(8rem,1fr)_7rem_4.5rem_6rem_6rem_6rem_auto] sm:items-end">
